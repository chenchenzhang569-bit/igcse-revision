...
# Our 44 subtopics from DB: list of (code, displayName)
OUR_SUBTOPICS = [
    ("1.1", "Compound Measures"),
    ("1.2", "Fractions, Decimals & Percentages"),
    ("1.3", "Introduction to Fractions"),
    ("1.4", "Money Calculations"),
    ("1.5", "Operations with Fractions"),
    ("1.6", "Operations with Numbers & Decimals"),
    ("1.7", "Percentages"),
    ("1.8", "Powers, Roots & Standard Form"),
    ("1.9", "Prime Factors, HCF & LCM"),
    ("1.10", "Ratio & Proportion"),
    ("1.11", "Reading & Ordering Numbers"),
    ("1.12", "Rounding, Estimation & Bounds"),
    ("1.13", "Simple & Compound Interest"),
    ("1.14", "Time, Currency & Conversions"),
    ("1.15", "Types of Numbers"),
    ("1.16", "Using a Calculator"),
    ("2.1", "Algebraic Roots & Indices"),
    ("2.2", "Expanding & Factorising Brackets"),
    ("2.3", "Inequalities"),
    ("2.4", "Introduction to Algebra"),
    ("2.5", "Linear Equations"),
    ("2.6", "Rearranging Formulas"),
    ("2.7", "Sequences"),
    ("2.8", "Simultaneous Equations"),
    ("3.1", "Further Graphs"),
    ("3.2", "Linear Graphs"),
    ("3.3", "Real-Life Graphs"),
    ("4.1", "Angles in Polygons & Parallel Lines"),
    ("4.2", "Basic Angle Properties"),
    ("4.3", "Bearings, Constructions & Scale Drawings"),
    ("4.4", "Circle Theorems"),
    ("4.5", "Symmetry & Shapes"),
    ("5.1", "Area & Perimeter"),
    ("5.2", "Circles, Arcs & Sectors"),
    ("5.3", "Congruence & Similarity"),
    ("5.4", "Volume & Surface Area"),
    ("6.1", "Pythagoras"),
    ("6.2", "Trigonometry"),
    ("7.1", "Transformations"),
    ("8.1", "Basic Probability"),
    ("8.2", "Set Notation & Probability Diagrams"),
    ("9.1", "Averages & Range"),
    ("9.2", "Scatter Graphs & Correlation"),
    ("9.3", "Statistical Diagrams"),
]
