...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6" style={{ fontFamily: "'Inter', 'Poppins', system-ui, sans-serif" }}>
      ...
      {/* ROW 1: Quick Links — 4 dark blue cards */}
      ...
      {/* ROW 2: Stats cards — blue backgrounds, orange numbers */}
      ...
      {/* ROW 3: Recent Activity — blue background */}
      <div className="rounded-2xl p-6" style={{ background: "linear-gradient(135deg, #001C71, #001a60)" }}>
        ...
        {s.recent.length > 0 ? (
          ...
          <p className="text-sm text-white/50 py-4 text-center font-medium">
