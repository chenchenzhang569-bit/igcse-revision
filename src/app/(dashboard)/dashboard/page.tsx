  ...
  return (
    <div className="space-y-6" style={{ fontFamily: "'Inter', 'Poppins', system-ui, sans-serif" }}>
      <div className="flex items-center justify-between py-4">
        ...
        <Link href="/invite" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white shadow-sm hover:shadow-md hover:brightness-110 transition-all" style={{ background: "linear-gradient(135deg, #FF8C00, #E67E00)" }}>
                  ...
                  <div key={slug} className="relative flex flex-col items-center" style={{ height: 210 }}>
                    <svg width="130" height="130" viewBox="0 0 130 130">
                      {(() => {
                        ...
                        return (
                          <>
                            {/* Background ring - blue (incorrect portion) */}
