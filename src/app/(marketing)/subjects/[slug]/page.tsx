...
export default async function SubjectPage({
  ...
  const useDbTopics = (key === "maths" || key === "0606" || key === "economics" || key === "computer-science" || key === "further-maths" || key === "business" || key === "geography" || (slug.startsWith("edexcel") && (key === "chemistry" || key === "biology"))) && subjectId;
  if (useDbTopics) {
    try {
      const supabase = createClient();
