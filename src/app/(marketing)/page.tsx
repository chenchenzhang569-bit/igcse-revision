        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 w-full max-w-[540px]">
            <video
              ...
              controls
              poster="https://cdn.jsdelivr.net/gh/chenchenzhang569-bit/igcse-revision@92e0dda/public/promo-poster.png"
              playsInline
              ...
              preload="auto"
            >
              <source src="https://cdn.jsdelivr.net/gh/chenchenzhang569-bit/igcse-revision@92e0dda/public/promo-video.mp4" type="video/mp4" />
            </video>
          </div>
        </div>
      </section>
