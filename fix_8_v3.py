"""
Fix 8 physics questions — correct SME topic-questions URLs.
"""
...
QUESTIONS = [
    {"id": "69970d70-8e57-45ff-90be-d9adaaf94057", "match": "speed-time graph for a train", "url": "1-motion-forces-and-energy/1-2-motion/exam-questions/"},
    {"id": "72f32ac4-a2ce-4920-9a76-dab23f8bfb3c", "match": "length of string is measured", "url": "1-motion-forces-and-energy/1-1-physical-quantities-and-measurement-techniques/exam-questions/"},
    {"id": "67f2a173-f9d5-4858-ac4d-b78ca3cbc14f", "match": "Two runners take part", "url": "1-motion-forces-and-energy/1-2-motion/exam-questions/"},
    {"id": "dc7b03a7-ca9e-4458-b0d2-9b21d661de6d", "match": "converging lens of focal length", "url": "3-waves/3-2-light/exam-questions/"},
    {"id": "ee004e91-8cb1-4e6d-b1df-7d54fc58a002", "match": "voltage-time graphs for two electrical", "url": "4-electricity-and-magnetism/4-2-electrical-quantities/exam-questions/"},
    {"id": "2d3fe00b-34a7-4948-82b5-8f5c1d5bdfd8", "match": "emissions from a source passing", "url": "5-nuclear-physics/5-2-radioactivity/exam-questions/"},
    {"id": "9ed928ed-b889-4b66-b1e2-6593f03c4a81", "match": "stream of", "url": "5-nuclear-physics/5-2-radioactivity/exam-questions/"},
    {"id": "589ea2b4-42c8-4f48-b671-1adfc978a0b6", "match": "pulse of sound is produced", "url": "3-waves/3-4-sound/exam-questions/"},
]
...
for i, q in enumerate(QUESTIONS, 1):
    ...
    for sq in questions:
        ...
        if not problem:
            # Try through attributes.parts[0].problem
            attrs = sq.get('attributes', {})
            parts = attrs.get('parts', [])
            problem = parts[0].get('problem', []) if parts else []
